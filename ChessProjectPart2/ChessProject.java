  ...
  for(int i=0;i < 4;i++)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if(!(piecePresent(((tmp.getXC()*75)+20), (((tmp.getYC()*75)+20))))
                &&(tmp.getYC()-startingSquare.getYC())==1)
                {
          attackingMove.push(tmpmove);
        }
      }
...
/*
    Method for return all the squares that a Knight can attack. The knight is possibly the simplest piece
...
/*******************************************************************************************************
Different Game Methods
********************************************************************************************************/
//Random Move AI
       Move selectedMoveRandom = agent.randomSelectedMove(testing);
//NextBestMove AI
  ...
  private Boolean pieceMove(int x, int y){
	...
	*/
    public static void main(String[] args) {
        ...
        Object[] options = {"Random Moves","Best Next Move","Two Stories down (Not done)"};
